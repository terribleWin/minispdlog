...
void benchmark_async_mt(int iterations) {
    ...
    auto logger = minispdlog::async_file_mt("bench_async_block", "logs/mini_async_block.log", true,
...
void benchmark_async_overrun(int iterations) {
    ...
    auto logger = minispdlog::async_file_mt("bench_async_overrun", "logs/mini_async_overrun.log", true,
...
void benchmark_multi_thread_async(int thread_count, int messages_per_thread) {
    ...
    auto logger = minispdlog::async_file_mt("bench_multi_async", "logs/mini_multi_async.log", true,
                                            minispdlog::async_overflow_policy::block);
